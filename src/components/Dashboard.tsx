...
export default function Dashboard({ session, onSignOut }: DashboardProps) {
  ...
  return (
    <main className="min-h-screen bg-[#fffaf8] pb-24">
      ...
      <div className="mx-auto max-w-5xl px-4 py-8"><div className="mb-8"><p className="text-sm font-bold uppercase tracking-[0.18em] text-rose-500">Good to see you</p><h1 className="mt-1 text-4xl font-black text-gray-900">{displayName}.</h1><p className="mt-2 text-gray-500">{profile?.bio || 'Discover people who are close to your kind of wonderful.'}</p></div>
