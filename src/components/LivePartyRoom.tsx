...
import { ChevronLeft, Gift, Mic, MicOff, Radio, Send, Share2, X } from 'lucide-react';
    ...
    <section className="space-y-4">
      <div className={`relative overflow-hidden rounded-[2rem] bg-gradient-to-br ${props.theme} p-4 shadow-2xl`}>
        <div className="flex items-center justify-between">
          <button type="button" className="rounded-full bg-black/20 p-2"><ChevronLeft className="h-5 w-5" /></button>
